...
@Entity
@Table(name = "swap_offers", indexes = {
        @Index(name = "ix_swap_offers_to", columnList = "to_user_id, createdAt"),
        @Index(name = "ix_swap_offers_from", columnList = "from_user_id, createdAt")})
@Getter
@Setter
