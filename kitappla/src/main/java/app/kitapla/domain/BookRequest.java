...
@Table(name = "requests", indexes = {
        @Index(name = "ix_requests_student", columnList = "student_id, createdAt"),
        @Index(name = "ix_requests_status", columnList = "status, createdAt"),
        @Index(name = "ix_requests_fulfilled_by", columnList = "fulfilled_by_id")})
@Getter
@Setter
