...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Üretimde KITAPLA_ADMIN_PASSWORD tanımsızsa sessizce varsayılana düşülüyordu: yönetici
        ...
        if (VARSAYILAN_SIFRE.equals(resolvedAdminPassword)) {
            if (environment.acceptsProfiles(org.springframework.core.env.Profiles.of("prod"))) {
                throw new IllegalStateException(
                        "KITAPLA_ADMIN_PASSWORD tanımlı değil. Üretimde yönetici hesabı varsayılan "
            ...
            log.warn("Yönetici hesabı varsayılan şifreyle çalışıyor ({}). Yerel deneme dışında "
                    + "KITAPLA_ADMIN_PASSWORD ortam değişkenini ayarla.", normalizedAdminEmail);
        }
