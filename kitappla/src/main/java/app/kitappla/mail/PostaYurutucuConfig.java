 ...
 * {@code kitappla.mail.async=false} (testler) teslimi aynı iş parçacığında yapar.
 */
@Configuration
public class PostaYurutucuConfig {
    ...
    @Bean(name = BEAN)
    public TaskExecutor postaYurutucu(@Value("${kitappla.mail.async:true}") boolean async) {
