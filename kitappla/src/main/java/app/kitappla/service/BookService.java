...
public class BookService {
    ...
    public Optional<Book> find(String title, String author) {
        ...
        return books.findFirstByTitleAndAuthorNormalized(t, a);
    }

    public List<Book> search(String query) {
        String q = clean(query, 100);
        if (q == null) return books.findTop50ByOrderByTitleAsc();
     ...
     * <p>
     * Bilerek işlem (transaction) açmaz: sayfa ve kapak indirme dış siteye bağlıdır ve
     * saniyeler sürebilir. İşlem içinde yapıldığında her istek bu süre boyunca havuzdan bir
     * veritabanı bağlantısı tutuyor, yavaş sitelere birkaç eşzamanlı ekleme havuzu
     * tüketebiliyordu. Okuma ve kayıtlar depo çağrılarının kendi kısa işlemlerinde yapılır.
     */
    public Book findOrCreate(String title, String author, String purchaseLink, String coverUrl,
        ...
        if (link != null && !link.matches("(?i)^https?://.+")) {
            link = null;
        }
        ...
        if (link != null && (t == null || cover == null || a == null || desc == null)) {
