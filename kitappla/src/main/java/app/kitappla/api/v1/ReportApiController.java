...
import app.kitappla.api.dto.MyReportDto;
import app.kitappla.api.dto.ReportBody;
...
public class ReportApiController {
    ...
    public ResponseEntity<java.util.List<MyReportDto>> mine() {
        ...
        java.util.List<app.kitappla.domain.Report> raporlar = reportService.mine(me);
        java.util.Map<Long, Long> sohbetler = messageService.conversationIds(ConversationKind.REPORT,
                raporlar.stream().map(app.kitappla.domain.Report::getId).toList());
