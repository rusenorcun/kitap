...
import app.kitappla.service.NotificationSseHub;
...
public class NotificationController {
    ...
    /** Bildirime tıklandığında: okundu işaretle ve hedefine yönlendir. */
    @GetMapping("/{id}/git")
    public String git(@AuthenticationPrincipal AppUserDetails principal, @PathVariable Long id) {
        User user = principal.getUser();
        String hedef = notifications.consume(user, id);
        return "redirect:" + (hedef != null && !hedef.isBlank() ? hedef : "/panom");
    }
