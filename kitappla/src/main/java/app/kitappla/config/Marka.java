...
public class Marka {
    ...
    public Marka(
            @Value("${kitappla.name:}") String ad,
            @Value("${kitappla.domain:kitappla.com}") String domain,
            @Value("${kitappla.base-url:}") String siteAdresi,
            @Value("${kitappla.mail.from:}") String gonderenAdres,
            @Value("${kitappla.mail.from-name:}") String gonderenAd,
            @Value("${kitappla.contact.email:}") String iletisimEpostasi,
            @Value("${kitappla.admin-url:}") String yonetimAdresi) {
