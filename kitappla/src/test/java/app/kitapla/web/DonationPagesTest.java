...
class DonationPagesTest {
    ...
    @Autowired app.kitapla.service.AdminService admin;
    @Autowired app.kitapla.service.DonationService donationService;
    @Autowired app.kitapla.service.SwapService swapService;
    @Autowired app.kitapla.service.BookService bookService;
