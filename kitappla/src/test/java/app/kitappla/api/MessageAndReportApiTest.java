...
class MessageAndReportApiTest {
    ...
    @Autowired app.kitappla.service.ReportService reportService;
    ...
    void admin_rapor_listesini_gorebilir_ve_sonuclandirabilir() throws Exception {
        ...
        // Sonuçlandır
        var resolveBody = new app.kitappla.api.v1.AdminApiController.ResolveReportBody(true, "Gerekli uyarı yapıldı.");
