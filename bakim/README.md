...
`handle_errors 502 503 504` bloğu bu klasörü (`C:/Project/kitappla/kitappla/bakim`) sunar.

## Sayfanın kendisi

Uygulama çöktüğünde sunulacağı için tamamen kendi kendine yeter: dış CSS,
dış betik ve görsel dosyası yoktur. Renkler `kitappla.css`'teki tasarım
